...
public class Vehicle {
    ...
    */
    ...
    public Vehicle(String VIN, String make, String model, String year, boolean transmission, int color, int interiorColor, int type, BigDecimal MSRP, String imageURL, boolean featured) {
        this.VIN = VIN;
        this.make = make;
        this.model = model;
        this.year = year;
